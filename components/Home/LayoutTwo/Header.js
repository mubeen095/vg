      ...
      >
        <nav className="max-w-screen-xl px-2 md:px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
          ...
          <ul className="hidden lg:flex col-start-4 col-end-8 text-black-500  items-center">
            ...
            <Link href={'/'} >
            <a className="px-4 py-2 mx-2 cursor-pointer animation-hover inline-block relative text-black-500 hover:text-purple-600 ">Services</a>
            </Link>

            <Link href={'/'}>
            <a className="px-4 py-2 mx-2 cursor-pointer animation-hover inline-block relative text-purple-600 animation-active">Programs</a>
            </Link>
