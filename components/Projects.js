      ...
      <div id="features">
        <Container>
          <div class="md:w-2/3 lg:w-1/2">
            ...
            Are you ready to elevate your skills and shape your future?
            Look no further than Skill Garage, an AICTE-approved company
            dedicated to empowering students like you through diverse
            ...
            <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                  "Unlock a world of learning with Skill Garage! Enjoy lifetime access to all our courses
                   each receiving regular updates to keep you ahead in the world of coding and its competitions
                   Stay current, stay competitive, with Skill Garage."
                  </p>
                </div>
                <a
                  href="#"
            ...
            <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                  "Get access to twenty plus programs at the price of one!"
                  </p>
                </div>
                <a
                  href="#"
            ...
            <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                    "AI Chart offers live doubt-clearing sessions for all our users.
                    Clear your doubts instantly and excel in your learning journey with our dedicated support!"
                  </p>
                </div>
                <a
                  href="#"
            ...
            <div class="group relative bg-gray-50 dark:bg-gray-900 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8 transition duration-300 group-hover:bg-white dark:group-hover:bg-gray-800">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                  "Experience top-notch faculty from leading MNCs and prestigious IITs. 
                  Learn from the best to become the best with our expert instructors."
                  </p>
                </div>
                <a
                  href="#"
